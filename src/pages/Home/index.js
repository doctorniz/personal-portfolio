...
const Home = ({setCurrentPage}) => {
    ...
    const [quoteIndex, setQuote] = useState(Math.floor(Math.random()*randomQuotes.length))
    
    return (
        <div className="eachPage homePage" id="Home">
            <div className="title"> nizar ahmed ismail </div>
            <div className="quoteBar" onClick={()=>setQuote(Math.floor(Math.random()*randomQuotes.length))}>
                <div className="quoteBarQuote">
                "{randomQuotes[quoteIndex].quote}"
                </div>
                <div className="quoteBarSource">
                -{randomQuotes[quoteIndex].source}
                </div>
            </div>
            <div className="menuBar">
                <Link to="/doctor" onClick={()=>setCurrentPage("Bio")}> doctor </Link>
